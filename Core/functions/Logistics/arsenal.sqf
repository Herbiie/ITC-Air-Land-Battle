...
// ["H_Beret_red","H_Beret_grn","H_Beret_blk","H_Beret_grn_SF","H_Beret_brn_SF","H_Beret_02","H_Watchcap_blk","optic_ams","optic_khs_blk","bipod_01_f_blk","acc_pointer_ir","acc_flashlight","optic_arco_blk_f","optic_holosight_blk_f","optic_hamr","optic_nvs","optic_erco_blk_f","ACE_MX2A","ACE_Yardage450","LaserDesignator","B_UavTerminal","ACE_Altimeter","ACE_DAGR","ACE_Vector","ITC_Land_B_AR2i_Packed","ITC_EPLRS","ITC_Land_tablet_fdc","ACE_MicroDAGR","ITC_Rover_SIR","itc_land_tablet_spg","ACE_SpottingScope","ACE_Tripod","ClaymoreDirectionalMine_Remote_mag","ACE_FlareTripMine_Mag","ACE_M14","Laserbatteries","APERSTripMine_Wire_Mag","ATMine_Range_Mag","SatchelCharge_Remote_Mag","U_B_GhillieSuit","muzzles_snds_b","muzzles_snds_m","optic_tws","optic_AMS_snd","optic_LRPS"]
