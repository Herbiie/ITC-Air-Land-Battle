...
_faction = "Faction" call BIS_fnc_getParamValue;
	...
	switch (_faction) do {
		...
		case 1: {
			// CTRG
			[_box, ["H_HelmetSpecB_paint1","H_HelmetSpecB_paint2","H_HelmetSpecB_sand","H_HelmetSpecB_snakeskin","H_HelmetSpecB","U_B_CTRG_1","U_B_CTRG_3","V_PlateCarrier1_rgr","V_PlateCarrierL_CTRG","B_AssaultPack_cbr","B_CarryAll_oli","arifle_SPAR_01_blk_F","arifle_SPAR_02_blk_F","150Rnd_556x45_Drum_Mag_Tracer_F","30Rnd_556x45_Stanag","muzzles_snds_b","muzzles_snds_m","bipod_01_f_blk","acc_pointer_ir","acc_flashlight","launch_NLAW_F","30Rnd_556x45_Stanag_green","30Rnd_556x45_Stanag_red","30Rnd_556x45_Stanag_Tracer_Red","30Rnd_556x45_Stanag_Tracer_Green","30Rnd_556x45_Stanag_Tracer_Yellow","NVGoggles"]] call ace_arsenal_fnc_addVirtualItems;
		};
		Case 2: {
			// NATO
			[_box,
...
if (H_alb_gearTier >= 1) then {
	switch (_faction) do {
		...
		case 1: {
			// CTRG
			[_box, ["20rnd_762x51_mag","arifle_SPAR_03_blk_F","optic_tws","arifle_SPAR_01_GL_blk_F","launch_Titan_F","launch_B_Titan_short_F","Titan_AA","Titan_AT","Titan_AP"]] call ace_arsenal_fnc_addVirtualItems;
		};
		Case 2: {
			// NATO
			[_box,
			["arifle_MX_GL_F","arifle_MXM_F","srifle_DMR_03_tan_F","20Rnd_762x51_Mag","optic_AMS_snd"]] call ace_arsenal_fnc_addVirtualItems;
		};
	};
};
...
if (H_alb_gearTier >= 2) then {
	switch (_faction) do {
		...
		case 1: {
			// CTRG
			[_box, ["MMG_02_black_F","130Rnd_338_Mag","srifle_LRR_F","7Rnd_408_Mag","optic_LRPS"]] call ace_arsenal_fnc_addVirtualItems;
		};
		Case 2: {
			// NATO
			[_box,
...
if (H_alb_gearTier >= 3) then {
	switch (_faction) do {
		...
		Case 2: {
			// NATO
			[_box,
			["srifle_LRR_F","7Rnd_408_Mag","optic_LRPS","launch_MRAWS_olive_rail_F","MRAWS_HEAT_F","MRAWS_HE_F","NVGogglesB_blk_F"]] call ace_arsenal_fnc_addVirtualItems;
		};
	};
};
