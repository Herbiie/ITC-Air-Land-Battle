//loadout items
private ["_unit","_cfg","_gear","_items","_assignedItems","_weapons","_magazines","_backpack","_backpackRandom","_backpackSel","_head_gear","_head_gearRandom","_head_gearSel","_uniform","_uniformRandom","_uniformSel","_vest","_vestRandom","_vestSel","_goggles","_gogglesRandom","_gogglesSel","_priKit","_secKit","_pisKit","_backpackContents","_vestContents","_uniformContents","_aceEarPlugs","_aceMedic","_vehCargoWeapons","_vehCargoMagazines","_vehCargoItems","_vehCargoRucks"];
